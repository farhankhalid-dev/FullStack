...
const CourseRegistrationGeneric = ({ data }) => {
  ...
  React.useEffect(() => {
    const preselectedCourseIds = data.selectedCourseIds || [];
          ...
          {selectedItem === "calendar" ? (
            ...
            <div className="semester-content">
              <div className="semester-title">
                <h2>{data.semesters[selectedItem].semester}</h2>
              </div>
              <div className="course-content">
                {data.semesters[selectedItem].courses.map((course, courseIndex) => {
                      ...
                      {openCourses[course.CourseCode] &&
                        ...
                        courseStatus.includes("In Progress") ? (
                          <div className="course-message">
                            {statusMessage}
                            <p>
                              If you want to re-take this course, contact Learning
                              Facilitators
                            </p>
                          </div>
                        ) : (
            ...
            <StudentInfo studentData={data.studentInfo} />
          </div>
          )}
        </div>
      </div>
